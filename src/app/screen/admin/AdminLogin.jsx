...
export default function AdminLogin() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (data.user.email === "atharvakokane555@gmail.com") {
                console.log('Correct email, redirecting...');
                router.push("/admin/dashboard");
            } else {
                console.log('Wrong email, signing out...');
            ...
            <div className="w-full max-w-md bg-white rounded-xl border border-black/10 flex flex-col items-center gap-6 mx-4 shadow-sm">
                ...
                <form onSubmit={handleLogin} className="w-full px-6 pb-6 space-y-6">
                    ...
                    <p className="pt-2 text-sm text-[#999999] text-center font-normal">
                        Demo email: <span className="text-[#666666]">atharvakokane555@gmail.com</span>
                        <br />
                        Demo password: <span className="text-[#666666]">Atharva123</span>
                    </p>
                </form>
            </div>
        </div>
